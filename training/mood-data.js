...
{
    "_id" : `ObjectId("5b465ca12a1c2a6f81234ed5")`,
    "input" : "you're the worst",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b465ce92a1c2a6f8123503d")`,
...
{
    "_id" : `ObjectId("5b465dc72a1c2a6f81235457")`,
    "input" : "i love you ",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b465dd72a1c2a6f812354a8")`,
    "input" : "i hate you",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b465df42a1c2a6f81235520")`,
    "input" : "thank you!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b465fba2a1c2a6f81235e35")`,
    "input" : "i love tortilla chips!!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b477c102a1c2a6f8132cca8")`,
    "input" : "you're the best man",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f7a92a1c2a6f813a7164")`,
    "input" : "i love to lick my sweaty donkey balls",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f7b52a1c2a6f813a71f7")`,
    "input" : "i hate",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b47f7c02a1c2a6f813a7278")`,
    "input" : "kill me",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b47f7de2a1c2a6f813a73aa")`,
    "input" : "everything josh says",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f7fd2a1c2a6f813a750c")`,
    "input" : "no one cares",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b47f80c2a1c2a6f813a75b3")`,
    "input" : "zarah ",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b47f82d2a1c2a6f813a771f")`,
...
{
    "_id" : `ObjectId("5b47f8732a1c2a6f813a7a16")`,
    "input" : "I'm fucking awesome",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f8ac2a1c2a6f813a7c9a")`,
    "input" : "shit I'm hot!!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b47f8dc2a1c2a6f813a7eb9")`,
    "input" : "You doing hoe activities ",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f9202a1c2a6f813a81ca")`,
    "input" : "I love turtles",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b47f9e32a1c2a6f813a8a8b")`,
    "input" : "Knuck if you buck",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4a36d22a1c2a6f815155bc")`,
    "input" : "Who are you and what are you doing in my house?",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd2332a1c2a6f816a76ac")`,
    "input" : "Good case, Excellent value.",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd28b2a1c2a6f816a7ab1")`,
    "input" : "Works great!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b4cd2a62a1c2a6f816a7c05")`,
    "input" : "I bought this to use with my Kindle Fire and absolutely loved it!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd2ca2a1c2a6f816a7da6")`,
    "input" : "worthless product",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd2de2a1c2a6f816a7eb0")`,
    "input" : "I only hear garbage for audio.",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd3362a1c2a6f816a829e")`,
...
{
    "_id" : `ObjectId("5b4cd34a2a1c2a6f816a8395")`,
    "input" : "Buy a different phone - but not this",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd35b2a1c2a6f816a8469")`,
    "input" : "This phone works great",
    "__v" : 0,
    "trained" : true,
    "moods" : [ ],
    "sentiment" : 85
...
{
    "_id" : `ObjectId("5b4cd3882a1c2a6f816a8662")`,
...
{
    "_id" : `ObjectId("5b4cd3a02a1c2a6f816a8791")`,
    "input" : "Hated it",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b4cd3c12a1c2a6f816a88f9")`,
    "input" : "So I am here to warn you--DO NOT RENT THIS MOVIE, it is the dumbest thing you have never seen!",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd3df2a1c2a6f816a8a6b")`,
    "input" : "Really awful.",
    "__v" : 0,
    "trained" : true,
    "moods" : [
...
{
    "_id" : `ObjectId("5b4cd3f92a1c2a6f816a8ba2")`,
    "input" : "Then our food came out, disappointment ensued",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
...
{
    "_id" : `ObjectId("5b4cd41e2a1c2a6f816a8d7d")`,
    "input" : "The pizza selections are good.",
    "__v" : 0,
    "trained" : true,
    "moods" : [
            {
